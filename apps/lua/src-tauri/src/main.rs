...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::db::db_list_loop_uebungen,
            ...
            commands::natascha_read::db_activate_korrektur_revision,
            commands::natascha_read::db_delete_korrektur_revision,
            ...
            commands::planung::ferien_upsert,
            commands::planung::ferien_delete,
            commands::planung::ferien_seed,
            commands::planung::pause_list,
            commands::planung::pause_upsert,
            commands::planung::pause_delete,
            commands::planung::material_list,
            commands::planung::material_add,
            commands::planung::material_delete,
            commands::planung::ablage_pfad,
            commands::planung::woche_einplanen,
            commands::planung::planung_stunden,
