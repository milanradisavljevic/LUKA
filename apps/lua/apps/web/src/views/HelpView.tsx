  ...
  },
  {
    ...
    body: (
      <>
        ...
        <Steps items={[
          <><strong>Sprachfächer:</strong> Deutsch, Englisch, Französisch, Spanisch, Italienisch und Latein. Der Generator erzeugt Inhalte in der Zielsprache. Französisch, Spanisch und Italienisch haben eigene kuratierte Textsortenfamilien und Grundraster; Latein verwendet text- und übersetzungsbezogene Aufgaben ohne CEFR-Übertragung.</>,
        ...
        <P>Im Schritt „Generieren" gibt es für geschlossene Aufgaben die <strong>Digitale Selbstkontrolle</strong>. Sie vergleicht lokale Antworten deterministisch mit dem gespeicherten Schlüssel — ohne KI-Aufruf und ohne Upload. Offene oder materialgebundene Aufgaben werden nicht automatisch bewertet.</P>
        <Tip>Für Geschichte und andere Sachfächer gibt es die Blocktypen „Quellenanalyse“, „Timeline / Datierung“ sowie „Diagramm-/Datenanalyse“. Timeline-Datierungen und Datenanalyse-Belege werden nur aus dem Material übernommen. Weitere fachspezifische Blocktypen folgen schrittweise.</Tip>
      </>
    ),
  },
  {
