...
import { Home,BookOpen,SpellCheck,GraduationCap,Library,Settings,HelpCircle,ChevronLeft,ChevronRight,Plus,Bug } from 'lucide-react';
...
export function Sidebar({currentView,onViewChange,onNewDocument,onBugReport}:{currentView:ActiveView;onViewChange:(view:ActiveView)=>void;onNewDocument:()=>void;onBugReport:()=>void}){
