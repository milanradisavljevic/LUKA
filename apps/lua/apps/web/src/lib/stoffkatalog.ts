...
const DESKRIPTOREN: Deskriptor[] = [
  ...
  },
  {
    ...
    bereich: 'Grammatik',
    code: '',
    text: 'Die Schülerinnen können das Present Perfect Simple (have/has + past participle) bilden und mit since/for, already/just/yet anwenden.',
    quelle: '',
  },
  {
    id: 'at-en-un-gramm-7',
    ...
    bereich: 'Grammatik',
    code: '',
    text: 'Die Schülerinnen können Past Simple und Present Perfect Simple situationsgerecht unterscheiden und anwenden.',
    quelle: '',
  },
  {
    id: 'at-en-un-gramm-8',
    ...
    bereich: 'Grammatik',
    code: '',
    text: 'Die Schülerinnen können Fragen, Verneinungen und Kurzantworten in den gängigen englischen Zeitformen bilden.',
    quelle: '',
  },
  // -------------------------------------------------------------------------
  // Deutsch Unterstufe
...
const STOFF_ITEMS: StoffItem[] = [
  ...
  },
  {
    ...
    rahmenwerk: 'at-lehrplan',
    titel: 'Past Simple vs. Present Perfect',
    fach: 'englisch',
    stufe: 'unterstufe',
    kategorie: 'grammatik',
  ...
  },
  {
    ...
    rahmenwerk: 'at-lehrplan',
    titel: 'Questions, Negation, Short Answers',
    fach: 'englisch',
    stufe: 'unterstufe',
    kategorie: 'grammatik',
